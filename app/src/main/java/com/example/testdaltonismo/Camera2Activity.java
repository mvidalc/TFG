...
public class Camera2Activity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        if (GlobalVariables.modoBordes) {
            return bordesRosas(inputFrame);
        } else if (GlobalVariables.modoBN) {
            return bnMenosLoRojo(inputFrame);
        } else {
            return filtroRosa(inputFrame);
        }
    }

    public Mat bnMenosLoRojo(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        // MAT7 - convertir los pixeles seleccionados a matriz de 3 bits
        mat9.release();
        Imgproc.cvtColor(mat5, mat9, Imgproc.COLOR_BGRA2BGR);

        // MAT7 - add de las dos ultimas matrices
        mat10.release();
    ...
    public Mat bordesRosas(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
    ...
    public Mat filtroRosa(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
